      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-3xl border border-[#2B2622]/10 bg-white px-8 py-10 shadow-xl shadow-[#2B2622]/5">
          ...
          <div className="mb-8 text-center">
            <span className="flex h-12 w-12 mx-auto items-center justify-center rounded-full bg-[#B85C38]/10 text-xl">
              🛍️
            </span>
            <h1 className="mt-4 text-2xl font-bold text-[#2B2622]">Create an account</h1>
            <p className="mt-1 text-sm text-[#5A4F45]">Join Tarzan and start shopping</p>
          </div>
          ...
          <div className="my-6 flex items-center gap-3">
            ...
            <span className="text-xs text-[#5A4F45]">already a member?</span>
            <div className="h-px flex-1 bg-[#2B2622]/10" />
          </div>
        ...
        <p className="mt-6 text-center text-xs text-[#5A4F45]">
          ...
          <span className="underline cursor-pointer hover:text-[#B85C38]">Terms</span> and{' '}
          <span className="underline cursor-pointer hover:text-[#B85C38]">Privacy Policy</span>
        </p>
      </div>
    </div>
  );
